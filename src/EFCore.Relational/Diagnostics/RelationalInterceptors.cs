...
namespace Microsoft.EntityFrameworkCore.Diagnostics
{
    ...
    {
        private RelationalOptionsExtension _optionsExtension;
        ...
        public virtual IDbCommandInterceptor CommandInterceptor
            => FindExtension?.CommandInterceptor;
        ...
        /// </summary>
        private RelationalOptionsExtension FindExtension
            => _optionsExtension ??= Dependencies
                .ServiceProvider
